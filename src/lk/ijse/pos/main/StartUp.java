...
public class StartUp extends Application{
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        try {
            ...
            Parent root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/pos/view/Mainview.fxml"));
        ...
        public static void navigateToHome(Node node, Stage mainStage) {
            ...
            Platform.runLater(()->{
                ...
                try {
                    Parent root = FXMLLoader.load(StartUp.class.getResource("/lk/ijse/pos/view/Mainview.fxml"));
                    Scene mainScene = new Scene(root);
